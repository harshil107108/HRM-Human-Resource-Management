...
import PermissionCard from "../../../components/layout/PermissionCard";
  ...
  const handleSave = async () => {
    try {
      ...
      if (documents.offerLetter?.file instanceof File) {
        formData.append("offerLetter", documents.offerLetter.file);
      }

      if (documents.appointmentLetter?.file instanceof File) {
        formData.append("appointmentLetter", documents.appointmentLetter.file);
      }
      ...
      if (res?.success) {
        successAlert({
          title: EmployeeId ? "Employee Updated" : "Employee Added",
          text: EmployeeId
        ...
        console.error("Employee save failed:", res);
      }
    } catch (error) {
  ...
  return (
    <>
      <div className="hp-company-page">
        <HpHeader title="Employee" className="hp-company-page__header" />
            ...
            <div className="p-4">
              <div className="mb-8 flex items-start gap-5">
                <div className="relative">
                  <div
                    className={`flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border border-slate-200 bg-slate-100 ${
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <UploadCard
                  ...
                  onChange={(file) => handleDocumentChange("resume", file)}
                  onRemove={() => handleDocumentRemove("resume")}
                />
                ...
                <UploadCard
                  ...
                  onChange={(file) => handleDocumentChange("offerLetter", file)}
                  onRemove={() => handleDocumentRemove("offerLetter")}
                />
                ...
                <UploadCard
                  ...
                  onRemove={() => handleDocumentRemove("appointmentLetter")}
                />
                ...
                <UploadCard
                  ...
                  onRemove={() => handleDocumentRemove("otherDocuments")}
                />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <div className="overflow-hidden rounded-lg border border-[#dce3e7] bg-white shadow-[inset_0_1px_2px_rgba(255,255,255,0.9),0_1px_2px_rgba(0,0,0,0.08),0_4px_8px_rgba(0,0,0,0.10),0_8px_16px_rgba(0,0,0,0.06)]">
              ...
              <div className="p-4">
                <FormRenderer
                  formMethod={formmethod}
                  formSchema={payrollInformationSchema}
                />
              </div>
            </div>
            ...
            <div className="p-6 shadow-sm">
              <div className="grid grid-cols-4 gap-4">
                <PermissionCard
                  ...
                  onChange={(value) => togglePermission("financialView", value)}
                />
                ...
                <PermissionCard
                  ...
                  onChange={(value) => togglePermission("leaveApproval", value)}
                />
                ...
                <PermissionCard
                  ...
                  onChange={(value) => togglePermission("orgChartAdmin", value)}
                />
