...
const Department = () => {
  ...
  const { basicInfoSchema, employeeSchema, managementSchema } =
    useDepatmentConfig();

  const formmethod = useMemo(() => {
    return formMethod.createForm({
      schema: [...basicInfoSchema, ...employeeSchema, ...managementSchema],
    });
  }, []);
  ...
  return (
    <>
      <div className="hp-company-page">
        <HpHeader title="Department" className="hp-company-page__header" />
