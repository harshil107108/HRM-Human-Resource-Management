...
const useJobOpeningConfig = ({ handleDelete } = {}) => {
  ...
  const jobInformationSchema = [
    ...
    },
    {
      ...
      className: "col-span-4",
      nextFocusField: "numberOfPositions",
  ...
  const hiringInformationSchema = [
    {
      ...
      // required: true,
      className: "col-span-4",
      nextFocusField: "recruiter",
      prevFocusField: "maximumExperience",
